...
from jesFinance import forms
from jesFinance import importers
from jesFinance import models
...
class ImportView(LoginRequiredMixin, generic.TemplateView):
    template_name = 'jesFinance/import.html'
...
class ImportUploadView(LoginRequiredMixin, generic.edit.CreateView):
    ...
    template_name = 'jesFinance/import_upload.html'
...
class ImportProcessView(LoginRequiredMixin, generic.TemplateView):
    template_name = 'jesFinance/import_configure_upload.html'
...
class ExportView(LoginRequiredMixin, generic.edit.FormView):
    template_name = 'jesFinance/export.html'
