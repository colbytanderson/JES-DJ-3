...
from jesFinance.forms import DepositForm, RecurringTransactionForm, TransferForm, WithdrawForm
from jesFinance.lib import last_day_of_month
from jesFinance.models import RecurringTransaction, Transaction
...
class RecurrenceTransactionCreateView(LoginRequiredMixin, generic.edit.CreateView):
    model = Transaction
    template_name = 'jesFinance/transaction_edit.html'
...
class RecurringTransactionIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'jesFinance/recurring_transactions.html'
...
class DisabledRecurrencesView(LoginRequiredMixin, generic.ListView):
    template_name = 'jesFinance/disabled_recurrences.html'
