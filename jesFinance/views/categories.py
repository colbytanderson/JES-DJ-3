...
from jesFinance.forms import CategoryAssignFormset
from jesFinance.lib import last_day_of_month
from jesFinance.models import Account, Category, Split


class CategoryIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'jesFinance/category_index.html'
    model = Category
...
class CategoryByMonth(LoginRequiredMixin, generic.TemplateView):
    template_name = 'jesFinance/category_by_month.html'
...
class InactiveCategoriesView(LoginRequiredMixin, generic.ListView):
    model = Category
    template_name = 'jesFinance/inactive_categories.html'
...
def assign_categories(request):
    ...
    return render(request, 'jesFinance/category_assign.html',
