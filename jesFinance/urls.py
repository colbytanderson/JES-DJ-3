...
from jesFinance import api
from jesFinance.rest import views as rest_views
from jesFinance.views import accounts as account_views
from jesFinance.views import budgets as budget_views
from jesFinance.views import categories as category_views
from jesFinance.views import charts as chart_views
from jesFinance.views import imports as import_views
from jesFinance.views import index as general_views
from jesFinance.views import recurrences as recurrence_views
from jesFinance.views import reports as report_views
from jesFinance.views import transactions as transaction_views
...
urlpatterns = [
    ...
    path('manifest.json', TemplateView.as_view(template_name='jesFinance/manifest.json'),
         name='manifest'),
